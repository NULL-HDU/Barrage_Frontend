...
//
//             if (x > left && x < right && y > top && y < bottom) {
//                 if (map.visible[userId] !== undefined && map.visible[userId][id] !== undefined) {
//                     visible[userId][id] =  map.visible[userId][id];
//                     delete map.visible[userId][id];
//                     updateBall(visible[userId][id], x, y, r, radius * 2);
//                 } else if (
//                     map.invisible[skinId] !== undefined &&
//                     map.invisible[skinId].length !== 0
//                 ) {
//                     visible[userId][id] =  map.invisible[skinId].pop();
//                     updateBall(visible[userId][id], x, y, r, radius * 2);
//                     visible[userId][id].visible = true;
//                 } else if (
//                     (map.visible[userId] === undefined || map.visible[userId][id] === undefined) &&
//                     (map.invisible[skinId] === undefined || map.invisible[skinId].length === 0 )
//                 )  {
//                     let con = new Container();
...
//                     }
//
//                     visible[userId][id] =  con;
//                     setObjectPosition(visible[userId][id], x, y);
//                     visible[userId][id].rotation = r;
//                     setObjectSize(visible[userId][id], radius * 2);
//
//                     // add self skinId
//                     visible[userId][id].mySkinId = skinId;
//                     layer.addChild(visible[userId][id]);
//                 }
//             }
//         }
//
//         for (let outKey in map.visible) {
//             for (let inKey in map.visible[outKey]) {
//                 let mySkinId = map.visible[outKey][inKey].mySkinId;
//                 if (map.invisible[mySkinId] === undefined) {
//                     map.invisible[mySkinId] = [];
//                 }
//                 map.visible[outKey][inKey].visible = false;
//                 map.invisible[mySkinId].push(map.visible[outKey][inKey]);
//             }
//         }
//         map.visible = visible;
